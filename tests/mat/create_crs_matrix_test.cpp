...
#include <mtl/mat/compressed_matrix.hpp>
...
//     mtl::mat::compressed_matrix<posit32> A{{1, 2, 0, 0}, {0, 0, 0, 3}, {0, 4, 5, 0}}; 
//     mtl::mat::compressed_matrix_internal<posit32, mtl::mat::parameters<> > Ai{A};
//     object_id a_id= create_crs_matrix<posit32>(3, 4, 5, Ai.ref_starts()[0], Ai.ref_indices()[0], Ai.ref_values()[0]);
