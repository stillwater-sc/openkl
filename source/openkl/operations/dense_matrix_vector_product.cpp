// dense_matrix_vector_product.cpp
// Created: 2020-03-27
//
...
void dense_matrix_vector_product(object_id u_id, object_id a_id, object_id v_id, Updater)
{
...
template void dense_matrix_vector_product<posit32, update_store>(object_id, object_id, object_id, update_store);
template void dense_matrix_vector_product<posit32, update_plus>(object_id, object_id, object_id, update_plus);
template void dense_matrix_vector_product<posit32, update_minus>(object_id, object_id, object_id, update_minus);
