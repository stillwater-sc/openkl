...
/// Check whether object_info \p test_value is equal \p expected_output, otherwise throw an assertion_not_fulfilled for \p context.
void check_object_output(object_id oi, std::string expected_output, std::string context)
{
