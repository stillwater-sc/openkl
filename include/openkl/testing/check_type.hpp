...
/// Throw \ref bad_down_cast if object referred by \p oi cannot be downcasted to type \p Target.
...
/// Throw \ref bad_down_cast in debug mode if object referred by \p oi cannot be downcasted to type \p Target.
template <typename Target>
